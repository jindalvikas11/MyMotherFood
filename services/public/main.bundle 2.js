...
var AppComponent = /** @class */ (function () {
    ...
    ], AppComponent.prototype, "dataReceived", void 0);
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getTotalItemInCart = function () {
        this.info.itemsInCart = 0;
        var cartItem;
        for (var i = 0; i < this.consumer.cart.length; i++) {
            this.info.itemsInCart = this.info.itemsInCart + Number(this.consumer.cart[i].food.quantity);
        }
    };
